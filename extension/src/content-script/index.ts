...
function buildTranslateRequest(
  ...
  return {
    ...
    pre_replacements: settings.config.preReplacements || undefined,
    post_replacements: settings.config.postReplacements || undefined,
    lettering_uppercase: settings.config.letteringUppercase || undefined,
    lettering_align: settings.config.letteringAlign || undefined,
    lettering_text_color: settings.config.letteringTextColor || undefined,
    lettering_outline_width: settings.config.letteringOutlineWidth || undefined,
    lettering_outline_color: settings.config.letteringOutlineColor || undefined,
